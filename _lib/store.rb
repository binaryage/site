...
def prune_shared(dir)
  ...
  sys("rm -rf \"#{css_dir}/nodes\"")
  sys("rm \"#{css_dir}/\"syntax.css")
  sys("rm \"#{css_dir}/\"bootstrap.css")
  sys("rm \"#{css_dir}/\"jquery.fancybox.css")
  sys("rm \"#{css_dir}/\"font-awesome.css")
  sys("rm \"#{css_dir}/\"fancybox*")
  ...
  sys("rm \"#{img_dir}/recovery-terminal-csrutil-enable-without-debug.png\"")
  sys("rm \"#{img_dir}/recovery-utilities-terminal.png\"")
  sys("rm -rf \"#{js_dir}\"")
end
